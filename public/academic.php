...
<div class="card"><h2>Modelo de acompanhamento</h2><p>O histórico do aluno passa a reunir quatro trilhas:</p><p><span class="pill">Financeiro</span> pagamento/contrato</p><p><span class="pill">Online</span> aulas iniciadas, concluídas e tempo assistido</p><p><span class="pill">Presencial</span> encontros, presença e minutos frequentados</p><p><span class="pill">Conclusão</span> situação acadêmica e certificado</p><p class="muted">Integração automática com gateway de pagamento e player de vídeo entra como conector desta mesma estrutura, sem necessidade de redesenhar o banco.</p></div>
</div>
