...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($action === 'create_student') {
            ...
            $stmt->execute([$courseId,(int)($_POST['organization_id'] ?? 0) ?: null,$name,(string)($_POST['modality'] ?? 'online'),(float)($_POST['planned_hours'] ?? 0),($_POST['start_date'] ?? '') ?: null,($_POST['end_date'] ?? '') ?: null,trim((string)($_POST['location'] ?? ''))?:null,'planejada']);
            aflash('Turma criada.');
