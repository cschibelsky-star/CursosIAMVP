...
$checks = [
    ...
    'tesseract_por' => str_contains((string)shell_exec('tesseract --list-langs 2>/dev/null'), 'por'),
    'db' => false,
...
$checks['ocr_ready'] = $checks['pdftoppm'] && $checks['tesseract'] && $checks['tesseract_por'];
