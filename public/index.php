...
<body><div class="top"><strong>Cursos IA MVP</strong><span class="badge">HML · Criador de Curso v0.6</span></div><div class="layout"><aside><h3>Cursos</h3>
...
<hr style="border:0;border-top:1px solid #eee;margin:18px 0"><a class="btn secondary" href="./">+ Novo curso</a><p><a class="btn secondary" href="cidades_inclusivas.php">Modelo Cidades Inclusivas</a></p><p><a class="btn secondary" href="academic.php">Controle Acadêmico</a></p><?php if ($course && $firstApproved): ?><p><a class="btn secondary" href="factory.php?course=<?= $courseId ?>">Fábrica do Curso</a></p><?php endif; ?><p class="muted" style="margin-top:18px"><a href="diagnostic.php">Diagnóstico técnico</a></p></aside><main class="content">
<?php if ($flash): ?><div class="flash <?= h($flash['type']) ?>"><?= h($flash['message']) ?></div><?php endif; ?>
<?php if (!$course): ?>
<div class="card"><h1>Criar novo curso</h1><p class="muted">Cadastre o objetivo pedagógico antes das fontes.</p><p><a class="btn secondary" href="cidades_inclusivas.php">Usar modelo oficial Cidades Inclusivas</a></p><p><a class="btn secondary" href="academic.php">Abrir Controle Acadêmico</a></p><form method="post"><input type="hidden" name="action" value="create_course"><label>Título do curso</label><input name="title" required><label>Público-alvo</label><input name="audience" required><label>Objetivo principal</label><textarea name="objective" required></textarea><br><button class="btn">Criar curso e continuar</button></form></div>
<?php else: ?>
